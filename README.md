...
Research and decision tracking for a 2026/2027 Ford F-150 purchase.

## Target Configuration — Finalized

**2026 Ford F-150 Lariat 501A**

| | |
|---|---|
| Cab / Bed | SuperCrew, 6.5'' box |
| Drivetrain | 4x4, 3.5L EcoBoost, 10-speed |
| Towing | Max Tow Axle (3.55 e-Lock) + Tow/Haul Package — 13,500 lb rating |
| Off-Road | FX4 Off-Road Package |
...
Towing rental travel trailers (lighter class, e.g. ~4,950–6,395 lb GVWR) from the Phoenix area to the AZ high country (Flagstaff, Payson, Prescott, Show Low, Mogollon Rim, Schnebly Hill Road) with a family of four. All towing go/no-go checks confirmed green.
...
| File | Contents |
|---|---|
|  | Towing capability go/no-go reference |
|  | Pre-purchase checklist for the specific truck |
|  | Loaded weight estimates vs. payload/tow thresholds |
|  | Saved builds across brands for comparison |
|  | PDF printouts of saved builds |
